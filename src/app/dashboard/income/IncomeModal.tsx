                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative group">
                                <div className="absolute left-4 md:left-6 top-1/2 -translate-y-1/2 flex items-center gap-2 pointer-events-none z-10">
                                    ...
                                    <span className="font-black text-xl md:text-2xl text-blue-600/30 group-focus-within:text-blue-600 transition-colors">Rp</span>
                                </div>
                                <input
                                    type="text"
                                    required
                                    ...
                                    placeholder="0"
                                    className="w-full pl-[3.5rem] sm:pl-24 pr-6 md:pr-8 py-4 md:py-6 rounded-[24px] md:rounded-[32px] border-2 border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-blue-500/50 transition-all font-black text-2xl md:text-3xl text-blue-600 shadow-inner group-hover:border-blue-200 dark:group-hover:border-blue-800 no-spinner"
                                />
                            </div>
                        </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative group">
                                    <input
                                        ...
                                        className="w-full pl-12 pr-8 py-4 md:py-5 rounded-[20px] md:rounded-[24px] border-2 border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-blue-500/50 transition-all font-bold text-xs md:text-sm group-hover:border-blue-200 dark:group-hover:border-blue-800"
                                    />
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative group">
                                <input
                                    ...
                                    className="w-full pl-12 pr-8 py-4 md:py-5 rounded-[20px] md:rounded-[24px] border-2 border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-blue-500/50 transition-all font-medium text-xs md:text-sm group-hover:border-blue-200 dark:group-hover:border-blue-800"
                                />
