              ...
              <table className="w-full text-left border-collapse min-w-[600px] md:min-w-full">
                <thead>
                  <tr className="bg-gray-100/70 dark:bg-gray-800/50">
                    ...
                    <th className="px-4 md:px-6 py-4 md:py-5 text-[10px] md:text-[11px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest border-b border-gray-100 dark:border-gray-800">Rekening</th>
                  ...
                  {paginatedIncome.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors group">
                      ...
                      <td className="px-4 md:px-6 py-4 md:py-5">
                        <span className="inline-flex items-center px-2 md:px-3 py-1 md:py-1.5 rounded-xl text-[9px] md:text-[10px] font-black uppercase tracking-widest bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 border border-blue-100/50 dark:border-blue-800/50">
                      ...
                      <td className="px-4 md:px-6 py-4 md:py-5 text-xs md:text-sm font-black text-blue-600 text-center whitespace-nowrap">
                        + Rp {Number(item.amount).toLocaleString("id-ID")}
                      </td>
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
                <div className="p-2 bg-white/20 rounded-xl backdrop-blur-md border border-white/30">
                  <Plus className="w-3.5 md:w-4 h-3.5 md:h-4 text-white" />
                </div>
