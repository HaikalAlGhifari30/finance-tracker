        ...
        <div className="flex items-center gap-2 md:gap-3 w-full lg:max-w-md">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 md:py-3.5 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-[#1E1E2D] text-xs md:text-sm text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-rose-500/20 transition-all font-medium shadow-sm"
            />
          </div>
