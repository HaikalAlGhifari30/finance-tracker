              ...
              <div className="space-y-3">
                ...
                <div className="relative" ref={sourceRef}>
                  <button
                    ...
                    className={`w-full h-[68px] flex items-center justify-between px-5 rounded-[28px] border-2 transition-all font-black text-[13px] disabled:opacity-70 ${
                        isSourceOpen 
              ...
              <div className="space-y-3">
                ...
                <div className="relative group">
                  <select 
                    ...
                    className={`w-full pl-12 pr-8 py-5 rounded-[24px] border-2 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 focus:outline-none focus:border-orange-500/50 transition-all appearance-none cursor-pointer font-bold text-sm ${
                        isSavingSelected ? 'border-amber-500/50 text-amber-600' : 'border-gray-100 dark:border-gray-800'
                    }`}
                  >
                    {categories.map(cat => (
                      <option 
